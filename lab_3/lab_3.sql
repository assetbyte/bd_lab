...
INSERT INTO employees(employee_id, first_name, last_name, salary, hire_date, status, department)
values (1, 'Emma', 'Watson', 100000, '2025-05-29' , 'Active', 'IT' );

insert into employees(employee_id, first_name, last_name, salary, hire_date, status, department)
values
    (2, 'Mark', 'Taylor', 40000, '2025-05-29', 'Active', 'Finance'),
    (3, 'Sophie', 'Lee', 10000, '2025-01-22', 'Active', 'Finance'),
    (4, 'David', 'Brown', 32000, '2025-04-21', 'Active', 'IT')

insert into employees(employee_id, first_name, last_name, salary, hire_date, status, department)
values (5, 'Alice', 'Green', 50000 * 1.1, CURRENT_DATE, 'Active', 'HR')
...
VALUES (6,'Chris', 'Evans', 70000, CURRENT_DATE, 'IT')
...
INSERT INTO employees (employee_id,first_name, last_name, salary, hire_date, department)
SELECT 6,'Tony', 'Stark', 200000, CURRENT_DATE, 'Management'
WHERE NOT EXISTS (
...
INSERT INTO employees (employee_id, first_name, last_name, salary, hire_date, department)
VALUES
    (8,'John', 'Doe', 40000, CURRENT_DATE, 'Sales'),
    (9,'Jane', 'Doe', 42000, CURRENT_DATE, 'Sales'),
    (10, 'Mike', 'Smith', 45000, CURRENT_DATE, 'Sales'),
    (11, 'Emily', 'Davis', 46000, CURRENT_DATE, 'Sales'),
    (12, 'Robert', 'Brown', 47000, CURRENT_DATE, 'Sales');
